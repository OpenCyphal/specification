...
\begin{remark}
    ...
    \begin{itemize}
        ...
        such conversions are relatively computationally heavy. % relative to what? Not sure we need word relatively here. May want to just say "such conversions can be computationally heavy"
