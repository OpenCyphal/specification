...
the major data type version used by the emitter and that used by the receiver exceeds four:
...
The extra byte contains certain metadata for the needs of the transport protocol.
...
The field transfer ID is populated according to the specification provided in the section \ref{sec:transfer_id}.
