...
multi-frame transfers where the temporal ordering of the transport frames is distorted\footnote{%
...
If supported by the concrete transport layer implementation,
