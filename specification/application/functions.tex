...
or on a local area network (LAN) by means of so called \emph{modem nodes}\footnote{%
...
without dependency on application-specific means of communication\footnote{%
