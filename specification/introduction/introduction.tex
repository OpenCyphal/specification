...
\begin{description}
    ...
    call semantics with statically defined data types (schema).
    ...
    freely available; the reference implementations will be distributed under the terms of the permissive MIT License.
\end{description}
