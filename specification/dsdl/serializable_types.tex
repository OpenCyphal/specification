...
where the trailing integer represents the length of the void field attribute, in bits,
...
A tagged union schema must contain at least two field attributes.
A tagged union must not contain padding field attributes.
