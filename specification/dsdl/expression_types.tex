...
as a well-defined formal name allows DSDL processing tools to emit well-formed
...
The attributes and operators defined on set instances are listed in tables~\ref{table:dsdl_set_attributes}
