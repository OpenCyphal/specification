...
\subsection{Serializable metatype}
...
\begin{UAVCANSimpleTable}{Attributes defined on instances of serializable metatype}{|l l X|}
    Name & Type & Description
    \label{table:dsdl_metaserializable_attributes} \\

    \texttt{\_bit\_length\_} & $\texttt{set}_\texttt{<rational>}$ &
    The bit length set (section \ref{sec:dsdl_bit_length_set}) of this type. \\
