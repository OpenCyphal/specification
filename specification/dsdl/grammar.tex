...
\begin{remark}
    \begin{minted}{python}
        @assert {'cells', "inter" + "linked"} == {"cells", 'interlinked'}
    \end{minted}
\end{remark}
...
\begin{UAVCANSimpleTable}{Reserved identifier patterns (POSIX ERE notation, ASCII character set)}{|l X|}%
    \label{table:dsdl_reserved_word_patterns}%
    POSIX ERE ASCII pattern                            & Special meaning \\
    ...
    \texttt{u?int\textbackslash{}d*}                   & Primitive type category \\
    \texttt{float\textbackslash{}d*}                   & Primitive type category \\
    \texttt{u?q\textbackslash{}d+\_\textbackslash{}d+} & Primitive type category (future) \\
    \texttt{void\textbackslash{}d*}                    & Void type category \\
    ...
    \texttt{com\textbackslash{}d?}                     & Compatibility with Microsoft Windows \\
    \texttt{lpt\textbackslash{}d?}                     & Compatibility with Microsoft Windows \\
    \texttt{\_.*\_}                                    & Special-purpose intrinsic entities \\
\end{UAVCANSimpleTable}
