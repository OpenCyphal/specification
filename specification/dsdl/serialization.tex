...
It is guaranteed by design that no error states may occur during serialization.
...
It is guaranteed by design that no other error states may occur during deserialization.
