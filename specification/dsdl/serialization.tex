...
The manual approach to data alignment allows the data type designer to trade serialization efficiency
...
A serialized representation of a composite type object is an ordered set of serialized representations of
...
\begin{remark}
    ...
    \begin{minted}{python}
        @union           # In this case, the implicit union tag is 2 bits wide
