...
\begin{remark}
    ...
    $$
        ...
        \underbrace{%
            ...
            \overbrace{%
                ...
                \underset{1}{\overset{9}{\hugett{0}}}%
                \underset{0}{\overset{8}{\hugett{1}}}%
            }^{\texttt{first}}%
        }_{\texttt{byte 1}}%
        \hugett{,}%
        \underbrace{%
    ...
    Note that some of the complexity of the above illustration stems from the western convention of representing
    ...
    not recommended both because the convention is deeply ingrained in most readers, tools, and technologies; and
    because the bits in each byte are put onto the CAN bus in the left-to-right order shown. Said differently;
    CAN is "bit big-endian" and UAVCAN is "byte little-endian" on top of CAN. 
\end{remark}
