...
\begin{remark}
    The serialized representation of integer 123 of type \verb|uint9| is $0111101100000000_2$.
\end{remark}
...
\begin{remark}
    The serialized representation of integer -123 of type \verb|int9| is $01000010100000001_2$.
\end{remark}
