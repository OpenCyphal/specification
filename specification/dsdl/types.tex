...
\begin{UAVCANSimpleTable}{Serializable type attributes}{|l l X|}
    ...
    \texttt{\_bit\_length\_} & $\texttt{set}_\texttt{<rational>}$ &
...
\begin{UAVCANSimpleTable}{Operators defined on primitive types}{|l l X|}
    Op & Type & Description
    \label{table:dsdl_operators_boolean} \\
...
\begin{UAVCANSimpleTable}{Operators defined on rational numbers}{|l l X X|}
...
\begin{UAVCANSimpleTable}{Operators defined on Unicode strings}{|l l X|}
    Op & Type & Description
...
\begin{UAVCANSimpleTable}{Operators defined on sets}{|l l l X|}
    Op & Type & Constraints & Description
    \label{table:dsdl_operators_string} \\
