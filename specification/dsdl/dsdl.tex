...
if the set of all possible encoded representations of $B$
is a subset of all possible encoded representations of $A$.

$A$ and $B$ are said to be \emph{mutually compatible} if the sets of all possible encoded representations of
