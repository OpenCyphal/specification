...
\texttt{saturated} & Cast mode. \\
\texttt{truncated} & Cast mode. \\
\texttt{offset} & Usable only in assertions, evaluates into the set of possible bit offsets. \\
...
\texttt{true} & \texttt{bool} variant. \\
\texttt{false} & \texttt{bool} variant. \\
\texttt{con} & Reserved. \\
\texttt{prn} & Reserved. \\
\texttt{aux} & Reserved. \\
\texttt{nul} & Reserved. \\
\texttt{com\textbf{X}} & Reserved. \\
\texttt{lpt\textbf{X}} & Reserved. \\
...
without needing the in-depth anal\begin{UAVCANSimpleTable}{Compatibility between associated const and const type}{|l l|}
\textbf{Keyword} & \textbf{Description} \\
\texttt{offset} & Evaluates into the set of possible bit offsets at the point of evaluation.
\end{UAVCANSimpleTable}ysis required when checking assertions.
