...
segregated into three categories (the ranges are documented in chapter \ref{sec:application}):
...
layer (chapter \ref{sec:transport}), which implements automatic decomposition of
...
For more information see chapter \ref{sec:application}.
...
which is explored in detail in chapter~\ref{sec:application}.
...
More info is provided in chapter~\ref{sec:transport}.
